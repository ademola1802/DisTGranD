...
Original file is located at
    https://colab.research.google.com/drive/1wIrO4L2iF_k1K3-R0Z4NuHGQSKnYgjK-
"""
...
encoded_dict = {
    ...
    'mockery': 30,
    'others': 31,
    'precautionary measure': 32,
    'preemption': 33,
    'price': 34,
    'priority': 35,
    'question': 36,
    'recovery support': 37,
    'relief assistance': 38,
    'religion': 39,
    'request': 40,
    'rescue support': 41,
    'sarcasm': 42,
    'shelter provision': 43,
    'traumatic experience': 44,
    'unharmed': 45,
    'update': 46,
    'well wishes': 47,
}
...
df_train['event'] = df_train['sub_event'].map(encoded_dict)
df_test['event'] = df_test['sub_event'].map(encoded_dict)
